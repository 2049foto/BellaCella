<!--
  NGUỒN SỰ THẬT CỦA PROJECT NÀY. Thắng ../CLAUDE.md về mọi sự thật riêng —
  trừ sáu ca phải-hỏi và luật verify, hai thứ đó không override được.
  Chuyển 26/09 từ CLAUDE.md cũ (84 dòng), nguyên văn, không cắt.
  Chứa product fact + cam kết pháp lý: KHÔNG xoá dòng nào mà không hỏi anh.
-->

# BELLA CELLA — Website thương hiệu

**Trạng thái: đã deploy nội bộ, CHƯA mở công khai.** Next.js, không phải app mobile.
